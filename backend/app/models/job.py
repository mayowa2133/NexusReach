...
class Job(Base):
    ...
    auto_research_status: Mapped[str | None] = mapped_column(String(50))
    auto_research_requested_at: Mapped[datetime | None] = mapped_column(
        DateTime(timezone=True)
    )
    auto_research_completed_at: Mapped[datetime | None] = mapped_column(
        DateTime(timezone=True)
    )
    auto_research_error: Mapped[str | None] = mapped_column(Text)
    auto_research_snapshot: Mapped[dict | None] = mapped_column(JSONB)
